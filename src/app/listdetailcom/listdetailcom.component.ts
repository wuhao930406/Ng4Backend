...
@Component({
  selector: 'listdetail-com',
  templateUrl: "./listdetailcom.component.html",
  styleUrls: [ './listdetailcom.component.css' ]
})
export class ListDetailcomComponent implements OnInit {
  ids:string;
  dataList = {};
  thisImg:string = "";
  isVisible = false;
