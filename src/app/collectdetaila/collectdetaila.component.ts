...
@Component({
  ...
  templateUrl: './collectdetaila.component.html',
  styleUrls: [ './collectdetaila.component.css' ]
})
export class CollectdetailaComponent implements OnInit {
  ...
  getDatas(){
    ...
    let urls = AllData.base_url+PortName.collect_list;
  ...
  deleteAll(key){
    let url = AllData.base_url+PortName.collect_delete;
